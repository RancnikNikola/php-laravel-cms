...
<div class="p-2 m-2 jumbotron">
    ...
    <div class="container-fluid m-2">
        ...
        <div class="btn-group col-md-6" role="group">
            ...
            <a class="btn btn-default" href="{{ route('nav_to_csv') }}">CSV</a>
            <a class="btn btn-default" href="{{ route('nav_to_excel') }}">Excel</a>      
            <a class="btn btn-default" href="{{ route('nav_to_pdf') }}">PDF</a>      
