            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="usrimg" class="col-md-4 col-form-label text-md-right">{{ __('User Image') }}</label>

                            <div class="col-md-6">
                                <input type="file" id="usrimg" class="form-control @error('usrimg') is-invalid @enderror" name="usrimg" value="{{ old('usrimg') }}">
